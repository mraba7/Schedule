...
internal enum class Design(val title: String, val number: String) {
    ...
    BENTO("الوحدات الملونة", "03"), ROUTE("المسار الليلي", "04"), SPORT("وقت التركيز", "05"), BLUEPRINT("المخطط الهندسي", "06"), GLASS("الجدول الزجاجي", "07"), FOCUS("الحصة بوضوح", "08"), PATH("مسار الحصص", "09"), INTERACTIVE("حصصي التفاعلية", "10")
}
