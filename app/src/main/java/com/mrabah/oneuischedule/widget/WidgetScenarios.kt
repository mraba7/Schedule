...
internal object WidgetScenarios {
    fun day(config:Config,state:PreviewState,now:LocalDateTime):DesignDay {
        ...
        val previewConfig=config.copy(absenceDate="",absenceLabel="",mutedDate="")
